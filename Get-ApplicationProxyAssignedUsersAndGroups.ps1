# Copied from https://docs.microsoft.com/en-us/azure/active-directory/manage-apps/scripts/powershell-display-users-group-of-app

# This sample script displays users and groups assigned to the specified Application Proxy application.
#
# Get-ApplicationProxyAssignedUsersAndGroups -ObjectId <ObjectId of the application>
#
...
If ($aadapServPrincObjId -eq "null") {
    ...
    Write-Host " "
    Write-Host "Get-ApplicationProxyAssignedUsersAndGroups -ObjectId <ObjectId of the application>" -BackgroundColor "Black" -ForegroundColor "Green"
    Write-Host " "
